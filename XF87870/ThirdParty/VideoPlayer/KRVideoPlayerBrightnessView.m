...
@interface KRVideoPlayerBrightnessView ()

@property (nonatomic, strong) NSMutableArray *blocksArray;

@end

@implementation KRVideoPlayerBrightnessView
...
- (void)createBrightnessIndicator
{
    ...
    [brightnessImageView setImage:[UIImage imageNamed:@"kr-video-player-brightness"]];
    [self addSubview:brightnessImageView];
    
    self.blocksArray = [NSMutableArray arrayWithCapacity:16];
    
    UIView *blockBackgroundView = [[UIView alloc] initWithFrame:CGRectMake((kVideoBrightnessIndicatorViewSide - 105) / 2, 50 + kViewSpacing * 2, 105, 2.75 + 2)];
